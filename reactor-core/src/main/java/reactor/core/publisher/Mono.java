...
//	 ==============================================================================================================
	 ...
	 *
	 * @param resourceSupplier a {@link Supplier} that is called on subscribe to generate the resource
	...
	public static <T, D> Mono<T> usingWhen(Supplier<D> resourceSupplier,
		...
		return onAssembly(new MonoUsingAsync<>(resourceSupplier, resourceClosure,
